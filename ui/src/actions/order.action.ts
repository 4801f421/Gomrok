...
export async function addOrder(data: any) {
	...
	const response = await axios.post(
		process.env.API_ADDRESS + ORDER_PATTERNS.ADD,
		data,
		{
			headers: {
				accept: "application/json",
...
export async function getOrder(data: any) {
	...
	const response = await axios.get(
		process.env.API_ADDRESS + ORDER_PATTERNS.GET + data.id,
		{
			headers: {
				accept: "application/json",
				"Content-Type": "application/json",
...
export async function buyOrder(data: any) {
	...
	const response = await axios.post(
		process.env.API_ADDRESS + ORDER_PATTERNS.BUY + data.id,
		{},
		{
			headers: {
				accept: "application/json",
...
export async function renewOrder(data: any) {
	...
	const response = await axios.post(
		process.env.API_ADDRESS + ORDER_PATTERNS.RENEW + data.id,
		{
...
export async function getOrderWithPanelUser(data: any) {
	...
	const response = await axios.get(
		process.env.API_ADDRESS + ORDER_PATTERNS.GET_WITH_PANEL_USER + data.id,
		{
			headers: {
				accept: "application/json",
				"Content-Type": "application/json",
...
export async function revokeSub(data: any) {
	...
	const response = await axios.post(
		process.env.API_ADDRESS +
			ORDER_PATTERNS.REVOKE_SUB.replace("{id}", data.id),
		{},
		{
			headers: {
				accept: "application/json",
